...
func TestInstructionString(t *testing.T) {
	tests := []struct {
		...
		{[]byte{0xb1, 0x23}, "0000 JPV0 291\n"},
		{[]byte{0xc1, 0x23}, "0000 RND 1 35\n"},
		{[]byte{0xd1, 0x23}, "0000 DRW 1 2 3\n"},
		{[]byte{0xe1, 0x9e}, "0000 SKP 1\n"},
		{[]byte{0xe1, 0xa1}, "0000 SKNP 1\n"},
		{[]byte{0xf1, 0x07}, "0000 LDVxDT 1\n"},
		{[]byte{0xf1, 0x0a}, "0000 LDK 1\n"},
		{[]byte{0xf1, 0x15}, "0000 LDDTVx 1\n"},
		{[]byte{0xf1, 0x18}, "0000 LDSTVx 1\n"},
		{[]byte{0xf1, 0x1e}, "0000 ADDIVx 1\n"},
		{[]byte{0xf1, 0x29}, "0000 LDF 1\n"},
